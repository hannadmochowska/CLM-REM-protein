...
RELIAB = [
    {"t": "HCRTR1", "r": "0.827", "rmse": "0.67", "note": "Most reliable", "tier": "high", "w": "83%"},
    {"t": "HCRTR2", "r": "0.733", "rmse": "0.75", "note": "Reliable",      "tier": "high", "w": "73%"},
    {"t": "CHRM2",  "r": "0.654", "rmse": "1.47", "note": "Reliable",      "tier": "high", "w": "65%"},
    {"t": "GABRA1", "r": "0.636", "rmse": "0.88", "note": "Moderate",      "tier": "mid",  "w": "64%"},
    {"t": "CHRM4",  "r": "0.585", "rmse": "1.06", "note": "Moderate",      "tier": "mid",  "w": "59%"},
    {"t": "ADORA1", "r": "0.584", "rmse": "0.96", "note": "Moderate",      "tier": "mid",  "w": "58%"},
]
...
CAVEATS = [
    ...
    "Performance measured on a global max_dissimilarity_2 split (17,149 compounds pooled across all 6 targets; test set built by MaxMin diversity picking, ECFP4 fingerprints, threshold=None, ~20% test) to prevent cross-dataset leakage.",
...
<body>
  ...
  <div class="panel" id="panel" style="display:none">
    <div class="cap">Pearson R · global max_dissimilarity_2 split · 5-seed mean</div>
...
st.markdown('<div style="height:46px"></div>', unsafe_allow_html=True)
components.html(reliab_html, height=90, scrolling=False)    {"t": "GABRA1", "r": "0.587", "rmse": "0.88", "note": "Moderate",      "tier": "mid",  "w": "59%"},
