...
│
├── [folder name unconfirmed]/      # Final CCPart train/test CSVs per target (12 files) — TODO: fill in actual folder name
│
...
└── Sesion1.ipynb                   # Starting-point notebook from RaulFD-creator/BiotechWorkshopAI (github.com/RaulFD-creator/BiotechWorkshopAI); notes in Spanish, code in English
```
